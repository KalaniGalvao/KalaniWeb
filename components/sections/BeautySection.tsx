  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex min-h-[100svh] items-start overflow-hidden pb-8 pt-[calc(env(safe-area-inset-top)+6.5rem)] md:sticky md:top-0 md:h-[100svh] md:items-center md:py-0"
      >
        ...
        <div className="container-rail relative z-10 grid w-full grid-cols-[minmax(0,0.9fr)_minmax(9.5rem,1fr)] items-start gap-3 py-0 md:grid-cols-[0.92fr_1.08fr] md:items-center md:gap-8 md:py-16 lg:gap-12">
          ...
          >
            <div className={`relative ${GLASS} rounded-[1.35rem] p-1.5 sm:p-6 md:rounded-[2rem]`}>
              ...
              <div className="relative flex items-stretch gap-3 sm:gap-5">
                ...
                <div className="relative mx-auto aspect-[3/5] h-[64svh] max-h-[32rem] w-full flex-1 overflow-hidden rounded-[1.15rem] bg-white/20 md:aspect-[3/4] md:h-auto md:max-h-none md:rounded-[1.5rem] md:bg-gradient-to-b md:from-white/85 md:to-white/35">
                  {HAIR_OPTIONS.map((option) => (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img
                      key={option.id}
          ...
          {/* ─────────────────── Copy panel (glass) ─────────────────── */}
          <article className={`order-2 h-[64svh] max-h-[32rem] min-w-0 overflow-y-auto ${GLASS} rounded-[1.35rem] p-3 sm:p-10 md:h-auto md:max-h-none md:max-w-none md:overflow-visible md:rounded-[2rem]`}>
            <BeautyReveal
              progress={scrollYProgress}
              start={0.1}
              end={0.32}
