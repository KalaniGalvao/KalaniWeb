  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ filter: reduce ? "none" : sceneFilter }}
        transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}
        viewport={{ once: true, amount: 0.5 }}
        className="container-rail relative z-10 grid items-center gap-12 py-24 text-left lg:grid-cols-[1.15fr_0.85fr] lg:gap-20"
      >
        <div>
