...
export function ContactSection({
  ...
  /** The cream marble→black melt only makes sense after Beauty on the homepage. */
  showTopMelt?: boolean;
} = {}) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <address className="not-italic">
          <div className="divide-y divide-white/10 border-y border-white/10">
            ...
            <a
              href="https://wa.me/5512997399123"
              target="_blank"
              rel="noreferrer"
              className="group flex items-center justify-between gap-6 py-6"
            >
      ...
      {/* Beauty -> contact edge melt. It echoes the anatomy -> beauty blur
          ...
          Only on the homepage (marble above); suppressed on service pages. */}
      {showTopMelt && (
        <motion.div
          aria-hidden="true"
