...
function DevWordMobile({
  ...
  // Mobile intentionally avoids CSS filter/blur. iOS Safari can show the
  // composited filter layer as gray/black bars during scroll-scrubbed fades.
  ...
  return (
    ...
    >
      <motion.span
        style={{ opacity, y }}
        className="block whitespace-nowrap text-2xl font-bold text-ink-100"
      >
        {word}
      </motion.span>
    </li>
