          ...
          <div className="max-w-xl text-right">
            ...
            >
              ...
              >
                ...
                <span className="accent-text">feita pensando no seu negócio</span>.
              </h1>
            </Reveal>
            ...
            >
              <p className="ml-auto mt-6 max-w-md text-pretty text-lg leading-relaxed text-ink-300 sm:text-xl">
                Fazemos uma reestruturação digital do seu negócio visando a
                diferenciação, otimização e usabilidade do seu website,
                colocando-o à parte de seus concorrentes e garantindo uma maior
                conversão de clientes e avanço das métricas.
              </p>
            </Reveal>
