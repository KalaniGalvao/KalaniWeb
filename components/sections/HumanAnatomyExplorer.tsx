          ...
          >
            <div>
              ...
              <motion.h3
                ...
                className="mt-2 max-w-[19rem] text-balance text-[2rem] font-semibold leading-[1.02] tracking-tightest text-white [text-shadow:0_2px_18px_rgba(0,0,0,.72)] sm:text-4xl md:mt-5 md:max-w-lg md:text-6xl md:[text-shadow:none]"
              >
                {layer.heading}
              </motion.h3>
            </div>
            ...
            <div
              className="pointer-events-auto absolute bottom-[calc(env(safe-area-inset-bottom)+4.65rem)] left-1/2 z-50 flex w-[calc(100vw-2rem)] -translate-x-1/2 flex-nowrap items-center justify-center gap-2 md:static md:mt-8 md:w-auto md:max-w-none md:translate-x-0 md:justify-start"
              role="tablist"
            ...
            >
              {LAYERS.map((item, index) => (
                <button
                  ...
                  className={`whitespace-nowrap rounded-full border px-3 py-1.5 text-xs font-medium backdrop-blur-md transition sm:px-4 sm:py-2 sm:text-sm ${
                    layerIndex === index
            ...
            <div
              className={
                infoHidden
                  ? "hidden md:block"
                  : "mt-3 rounded-[1.25rem] bg-[#02030a]/62 p-3 backdrop-blur-md md:mt-0 md:rounded-none md:bg-transparent md:p-0 md:backdrop-blur-none"
              }
            >
