      ...
      <div className="sticky top-0 h-[100svh] overflow-hidden bg-[#07101f]">
        ...
        <div className="container-rail pointer-events-none relative z-40 flex h-full items-start pt-[calc(env(safe-area-inset-top)+5.25rem)] md:items-center md:pt-0">
          ...
          >
            ...
            <div
              className="pointer-events-auto absolute bottom-[calc(env(safe-area-inset-bottom)+4.65rem)] left-1/2 z-50 flex max-w-[calc(100vw-2rem)] -translate-x-1/2 flex-wrap justify-center gap-2 rounded-full border border-white/10 bg-black/45 p-1.5 shadow-lg backdrop-blur-md md:static md:mt-8 md:max-w-none md:translate-x-0 md:justify-start md:rounded-none md:border-0 md:bg-transparent md:p-0 md:shadow-none md:backdrop-blur-none"
              role="tablist"
